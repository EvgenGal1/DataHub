...
export class AppController {
  ...
  getHello(@Res() res: Response): void {
    ...
    // ! ошб.Vercel - Error: ENOENT: no such file or directory, stat '/var/task/public/views/pages/welcome.html'
    // const viewPath = isProduction ? `/views/pages/welcome.html` : `/views/pages/welcome.html`;
    // res.sendFile(viewPath, { root: 'public' }); // возвращ.ф.HTML по пути из раб.п.
    // возвращ.html
    const htmlContent = `
      <!doctype html>
      <html>
